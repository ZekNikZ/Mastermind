...
public class MastermindWindow extends JFrame {
    ...
    public MastermindWindow() {
        ...
        for (int i = 0; i < PegColor.values().length; i++) {
            ...
            button.addActionListener(e -> {
                this.currentColor = PegColor.values()[j];
            });
        ...
        this.submitButton.addActionListener(e -> {
            switch (this.submitButtonState) {
                case 0:
                    MastermindGame.Move move = new MastermindGame.Move(this.moveColors);
    ...
    private static Box createPreviousMoveBox(MastermindGame.Move move) {
